...
const slideContent=[{src:`${BackgroundImage2}`, text: 'Богдан . Чемпион мира в дисциплине жим лёжа, многократный чемпион Украины! Тренируется со мной с 2013 года.', click:'Хочу также!'},{src:`${BackgroundImage1}`, text: 'shfb111111ssjhdfbj', click:'Хочу также!'},  {src:`${BackgroundImage4}`, text:'shfbsjhddd3333ddffgggggghhgdddddfbj', click:'Приступить!'}, {src:`${BackgroundImage3}`, text: 'shfb111111ssjhdfbj', click:'Приступить!'}, {src:`${BackgroundImage5}`, text: 'shfb111111ssjhdfbj', click:'Хочу также!'}, {src:`${BackgroundImage6}`, text: 'shfb111111ssjhdfbj', click:'Хочу также!'}, {src:`${BackgroundImage7}`, text: 'shfb111111ssjhdfbj', click:'Хочу также!'}, {src:`${BackgroundImage8}`, text: 'Михаил . Полностью восстановился после травмы спины , похудел на 18 кг за полтора года.', click:'Хочу также!'},{src:`${BackgroundImage9}`, text: 'Кристиан. Стаж тренировок два года. Занимается функциональным тренингом.', click:'Хочу также!'} ];
